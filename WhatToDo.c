// Its a file showing the msiions i need to do and if i have problems or idies for upgrading i write it here:

// ADDING:
// need to upgrade the send money systym you can from each acount send money to each other without entring the acoutn you send from
